...
import { FieldBase, FormFields, Rule, Rules } from './field';
...
export abstract class FieldView {
    ...
    constructor(formSchema: FormSchema, field: FieldBase) {
...
class UnkownInputSchema extends FieldView {
    protected setProps() {
...
abstract class SingleInputSchema extends FieldView {
...
class TextInputSchema extends FieldView {
...
class CheckBoxSchema extends FieldView {
    protected element: HTMLInputElement;
    setProps() {
...
export function inputFactory(formSchema: FormSchema, field: FieldBase): FieldView {
    switch (field.type) {
