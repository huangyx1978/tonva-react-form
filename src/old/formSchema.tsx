...
import {nav} from '../nav';
import {FieldBase, FormFields, Rule, Rules, SubmitResult} from './field';
import {FieldView, inputFactory, Err} from './fieldView';
import { FormEvent } from 'react';

export class FormSchema {
    private initValues: any;
    private _inputs: {[name:string]: FieldView};
    private submit: (values:any) => Promise<SubmitResult|undefined>;
    fieldTag: string;
    submitText: string;
    resetButton?: string;
    clearButton?: string;
    ...
    $(name:string):FieldView {return this._inputs[name];}
